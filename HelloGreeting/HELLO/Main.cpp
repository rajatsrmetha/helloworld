...
#include <HelloGreeting/HELLO/Top/HELLOTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    HelloGreeting::TopologyState inputs;
    ...
    HelloGreeting::setupTopology(inputs);
    HelloGreeting::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    HelloGreeting::teardownTopology(inputs);
