...
//
// ======================================================================
#ifndef HI_HITOPOLOGY_HPP
#define HI_HITOPOLOGY_HPP
// Included for access to HI::TopologyState and HI::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <HelloGreeting/HI/Top/HITopologyDefs.hpp>
 ...
 * HI::TopologyState see: HITopologyDefs.hpp.
 *
